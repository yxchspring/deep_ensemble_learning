...
model_folder = 'Action_DELWO1_Model'
...
Models_fusion = layers.concatenate([VGG16_output,VGG19_output,ResNet50_output],axis=-1)
x = Dense(2048, activation='relu')(Models_fusion)
