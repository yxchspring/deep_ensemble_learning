...
model_folder = 'Action_DELWO3_Model'
...
Branch_A = layers.Convolution2D(filters = 384, kernel_size=1,padding='same', activation='relu',strides = 1)(Models_fusion)
Branch_B = layers.Convolution2D(filters = 384, kernel_size=1,padding='same', activation='relu')(Models_fusion)
Branch_B = layers.Convolution2D(filters = 384, kernel_size=3,padding='same', activation='relu',strides = 1)(Branch_B)
Branch_C = layers.AveragePooling2D(pool_size=3,padding='same',strides = 1)(Models_fusion)
Branch_C = layers.Convolution2D(filters = 384, kernel_size=3, padding='same', activation='relu')(Branch_C)
